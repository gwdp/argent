export const FAILURE_CODES = {
  ...
  VEGA_CLI_NOT_FOUND: "VEGA_CLI_NOT_FOUND",
  ...
  VEGA_DEVICE_ID_INVALID: "VEGA_DEVICE_ID_INVALID",
  ...
  NATIVE_PROFILER_SESSION_STATE_INVALID: "NATIVE_PROFILER_SESSION_STATE_INVALID",
  NATIVE_PROFILER_APP_PROCESS_NOT_FOUND: "NATIVE_PROFILER_APP_PROCESS_NOT_FOUND",
  NATIVE_PROFILER_RECORDING_CRASHED: "NATIVE_PROFILER_RECORDING_CRASHED",
  ...
  PROFILER_SESSION_ID_INVALID: "PROFILER_SESSION_ID_INVALID",
  ...
  CHROMIUM_FACTORY_OPTIONS_INVALID: "CHROMIUM_FACTORY_OPTIONS_INVALID",
  ...
  SCREENSHOT_DIFF_CAPTURE_UNAVAILABLE: "SCREENSHOT_DIFF_CAPTURE_UNAVAILABLE",
